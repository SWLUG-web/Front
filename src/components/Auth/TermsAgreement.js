          ...
          <div className="form_agreement_box">
              ...
              <div className="agreement_text">
                <div className="agreement_section">
                  ...
                  <div className="section_content">
                    ...
                    <ol>
                      <li>- 회원은 본 약관과 소학회의 공지사항을 준수해야 하며, 서비스 이용 시 타인의 권리를 침해하거나, 동아리에 피해를 주는 행위를 하지 않습니다.</li>
            ...
            <div className="form_agreement_item">
              ...
              <div className="agreement_text">
                ...
                <ul>
                  <li>• 개인 식별, 동아리 활동 관련 공지사항 전달 및 운영 관련 설문조사</li>
                  <li>• 소학회 행사, 교육, 워크숍 정보 전송</li>
                </ul>

                <strong>3. 수집한 개인정보의 보유 및 이용 기간</strong>
                <ul>
                  <li>• 개인정보는 회원 탈퇴를 요청하거나 동의 철회를 요청한 경우 지체 없이 파기하며, 동아리 활동 종료 후 6개월 이내에 파기합니다.</li>
                  <li>• 법령에 따라 개인정보를 보관해야 하는 경우, 관련 법령에 따른 보관 기간 동안 이용자의 개인정보를 보관합니다.</li>
                </ul>

                <p className="notice">※ 이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 단, 동의를 거부할 경우 상기 정보 수집이 필수인 동아리의 서비스를 제공받을 수 없습니다.</p>
              </div>
            </div>
          </div>
        </div>
